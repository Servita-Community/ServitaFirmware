...
arduino-cli upload -p /dev/ttyUSB0 --fqbn esp32:esp32:esp32:PartitionScheme=huge_app Servita
if [ $? -ne 0 ]; then
...
arduino-cli monitor -p /dev/ttyUSB0 -b esp32:esp32:esp32:PartitionScheme=huge_app -c baudrate=115200
if [ $? -ne 0 ]; then
